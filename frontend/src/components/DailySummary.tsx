  ...
  return (
    <div className="bg-white dark:bg-darksurface rounded-lg shadow-md p-4 border border-gray-200 dark:border-gray-700 mb-6">
      ...
      <div className="flex flex-wrap gap-3 mb-4">
        <div className="flex-1 min-w-[120px] p-3 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
          <p className="text-xs text-gray-600 dark:text-gray-400">Reviews Today</p>
          <p className="text-xl font-light text-gray-900 dark:text-gray-100">{summary.total_reviews}</p>
        </div>
        <div className="flex-1 min-w-[120px] p-3 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
          <p className="text-xs text-gray-600 dark:text-gray-400">Correct</p>
          <p className="text-xl font-light text-gray-900 dark:text-gray-100">{summary.correct_reviews}</p>
        </div>
        <div className="flex-1 min-w-[120px] p-3 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
          <p className="text-xs text-gray-600 dark:text-gray-400">Accuracy</p>
          <p className="text-xl font-light text-gray-900 dark:text-gray-100">{formatPercent(summary.percent_correct)}</p>
        </div>
        <div className="flex-1 min-w-[120px] p-3 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
          <p className="text-xs text-gray-600 dark:text-gray-400">Streak</p>
          <p className="text-xl font-light text-gray-900 dark:text-gray-100">{summary.streak_days} days</p>
        </div>
      </div>
