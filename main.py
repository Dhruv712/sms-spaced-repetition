...
allowed_origins = os.getenv("ALLOWED_ORIGINS", "http://localhost:3000,https://hopeful-adventure-production.up.railway.app,https://sms-spaced-repetition-production.up.railway.app").split(",")
